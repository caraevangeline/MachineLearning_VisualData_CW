function TP_FP_mat = ism_test_voting(struct_fea, THRESH, DISP_FLAG,TEM_MEANSHIFT_WIDTH,LOW_THRESH, NO_OF_POINTS, DataStructureVotemap, Dictionary, a, b)
...
hough_array = houghvoting(patches,location,spa_scale,tem_scale,frame_num,flag_mat,DataStructureVotemap);
